...
export interface Booking{
	...
	booking_date: string
	/**	Payment Mode : Select	*/
	payment_mode: "Full Payment" | "Installments"
	...
	payment_plan_type?: "Fixed" | "Flexible"
	...
	/**	Other Charges Total : Currency	*/
	other_charges_total?: number
	/**	Token Paid : Currency	*/
	token_paid_total?: number
	/**	Advance Paid Total : Currency	*/
	...
	/**	Schedule Locked : Check	*/
	schedule_locked?: 0 | 1
	/**	Down Payment Percentage : Percent	*/
	down_payment_percentage?: number
	/**	Installment Interval : Select	*/
	installment_interval?: "Monthly" | "Quarterly" | "Semi-Annual"
	/**	Penalty Rule : Data	*/
	penalty_rule?: string
